...
description: "Step-by-step macOS developer setup: install tooling, clone the main repository, configure environment variables, and verify everything with the test suite."
---
