...
description: "Set up your local development environment on a fresh laptop: install dependencies, clone repos, run services locally, and get tests passing in an hour."
---
