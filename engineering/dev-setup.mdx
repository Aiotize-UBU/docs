...
description: "Developer setup guide for getting your local environment, repos, and tooling running on a fresh machine in under an hour, with troubleshooting tips."
---
