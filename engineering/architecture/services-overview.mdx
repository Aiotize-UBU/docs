...
description: "Map of the backend services that make up our platform, what each one is responsible for, and how they communicate with each other and shared data stores."
---
