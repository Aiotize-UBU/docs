...
description: "The microservices that make up our platform — what each service is responsible for, who owns it, and how services talk to each other in production."
---
