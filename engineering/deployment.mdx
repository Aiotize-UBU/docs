---
title: "Deployment"
description: "Trunk-based deployment flow from PR merge to staging and production, plus rollbacks, feature flags, database migrations, and deploy freeze windows."
---
