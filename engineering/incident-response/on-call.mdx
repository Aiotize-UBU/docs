...
description: "How the engineering on-call rotation works — schedules, response time expectations, paging tools, and how to escalate when you can't resolve an issue alone."
---
