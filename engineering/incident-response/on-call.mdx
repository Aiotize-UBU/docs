...
description: "On-call expectations for engineers: how the rotation works, response time targets, alert handling, escalation paths, and compensation for shifts."
---
