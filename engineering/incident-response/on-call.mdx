...
description: "How the on-call rotation works, what is expected of the primary responder, how to prepare for a shift, and how to escalate or hand off an incident."
---
