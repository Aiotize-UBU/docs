...
description: "Request access to internal tools, staging, and production systems: ticket process, access levels, approval routing, quarterly reviews, and offboarding steps."
---
